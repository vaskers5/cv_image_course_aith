...
def generate_patch_pairs(image, patch_ratio=0.2, gap_ratio=0.1, resize_size=224):
    ...
    patch1 = image[:, center_x:center_x + patch_size, center_y:center_y + patch_size]
    ...
    patch2 = image[:, patch2_x:patch2_x + patch_size, patch2_y:patch2_y + patch_size]
...
class SSLDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        patch1, patch2, label = generate_patch_pairs(image, self.patch_ratio, self.gap_ratio)
        return patch1, patch2, label
